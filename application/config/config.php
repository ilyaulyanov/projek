 ...
 */
define('URL', 'http://localhost:8080/projek/');
...
define("EMAIL_SMTP_USERNAME", 'keelodigital@gmail.com');
// SMTP provider password
define("EMAIL_SMTP_PASSWORD", 'keelodiplodocus');
// SMTP provider port
define("EMAIL_SMTP_PORT", 465);
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@projek-app.com");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "Projek");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for Projek");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@projek-app.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Projek");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Projek");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
...
define("FEEDBACK_PROJECT_CREATION_FAILED", "Project creation failed.");
